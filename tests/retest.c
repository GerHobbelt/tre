...
main(int argc, const char **argv)
{
  ...
  */
...
#ifdef SRC_IN_EUC_JP
  test_comp(raw2str(0xB5, 0xA1, '+', 0), REG_EXTENDED, 0);
  test_exec(raw2str(0xA4, 0xB3, 0xA4, 0xCE, 0xBE, 0xDE, 0xA4, 0xCF, 0xA1, 0xA2, 0xB5, 0xA1, 0xA1, 0xA6, 0xCD, 0xF8, 0xCA, 0xD8, 0xC0, 0xAD, 0xA1, 0xA6, 0xA5, 0xBB, 0xA5, 0xAD, 0),
            0, REG_OK, 10, 13, END);
#else
#ifdef SRC_IN_UTF_8
  ...
  test_exec(raw2str(0xE3, 0x81, 0x93, 0xE3, 0x81, 0xAE, 0xE8, 0xB3, 0x9E, 0xE3, 0x81, 0xAF, 0xE3, 0x80, 0x81, 0xE6, 0xA9, 0x9F, 0xE3, 0x83, 0xBB, 0xE5, 0x88, 0xA9, 0xE4, 0xBE, 0xBF, 0xE6, 0x80, 0xA7, 0xE3, 0x83, 0xBB, 0xE3, 0x82, 0xBB, 0xE3, 0x82, 0xAD, 0),
            0, REG_OK, 15, 18, END);
#else
      ...
      setlocale(LC_CTYPE, "ja_JP.eucJP") != NULL)
    {
	 ...
	 means, I took it from http://www.ipsec.co.jp/. */
      ...
      /* iconv -f EUC-JP -t UTF-8 file_with_lines_above > zzz_utf_8
         ...
         It compiles and runs successfully on my desktop with the C.UTF-8 locale. */
      test_comp(raw2str(0xE6, 0xA9, 0x9F, '+', 0), REG_EXTENDED, 0);
      test_exec(raw2str(0xE3, 0x81, 0x93, 0xE3, 0x81, 0xAE, 0xE8, 0xB3, 0x9E, 0xE3, 0x81, 0xAF, 0xE3, 0x80, 0x81, 0xE6, 0xA9, 0x9F, 0xE3, 0x83, 0xBB, 0xE5, 0x88, 0xA9, 0xE4, 0xBE, 0xBF, 0xE6, 0x80, 0xA7, 0xE3, 0x83, 0xBB, 0xE3, 0x82, 0xBB, 0xE3, 0x82, 0xAD, 0), 0, REG_OK, 10, 12, END);
#else
      /* Represent the test strings as a sequence of bytes so we don't run afoul of the compiler's expected source-charset. */
